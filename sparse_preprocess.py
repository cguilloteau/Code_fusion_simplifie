...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 28 17:09:49 2019
...
This code implents the preprocessing of the fusion process of infrared astronomical hyperspectral and multispectral images as described in [1,2].
"""
...
def get_hsms(MS_IM, HS_IM):
    ...
    sig2_ms = np.mean(Ync)
    # Get wavelengths
    tabwave = fits.getdata(DATA+'tabwave_low.fits')[:, 0]
...
def preprocess(Ync, Yns, Lm, Lh, mean):
    ...
    Ync = tools.compute_symmpad_3d(Ync, fact_pad)
